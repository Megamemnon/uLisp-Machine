...
//Megamemnon's uLisp Machine
#define serial1out
#define teensyusbhostkb
//End Megamemnon's uLisp Machine
...
//Megamemnon's uLisp Machine
CLEAR_SCREEN, SCREEN_HOME, SET_CURSOR_POSITION,
//End Megamemnon's uLisp Machine
...
char teensykey;
bool teensykeyAvailable;
bool teensykeyClearKbdBuff=false;
void OnPress(int key){
  char c=keyboard.getKey();
  teensykey=c;
  teensykeyAvailable=true;
}
#endif
//End Megamemnon's uLisp Machine
...
//Megamemnon's uLisp Machine
object *fn_clear_screen (object *args, object *env) {
#ifdef serial1out
  Serial1.write(0x00);
#endif  
  return nil;
...
object *fn_screen_home (object *args, object *env) {
#ifdef serial1out
  Serial1.write(0x01);
#endif
  return nil;
...
object *fn_set_cursor_position (object *args, object *env) {
#ifdef serial1out
  int arg1=checkinteger(ADD, first(args));
  int arg2=checkinteger(ADD, second(args));
  Serial1.write(0x0B);
  Serial1.write(arg1);
  Serial1.write(0x0A);
  Serial1.write(arg2);
...
//Kaef begin
const char string235[] PROGMEM = "ls";
const char string236[] PROGMEM = "rm";
const char string237[] PROGMEM = "rmdir";
const char string238[] PROGMEM = "mkdir";
//Kaef end

//Megamemnon's uLisp Machine
const char string239[] PROGMEM = "clear-screen";
const char string240[] PROGMEM = "screen-home";
const char string241[] PROGMEM = "set-cursor-position";
//End Megamemnon's uLisp Machine
...
// Kaef begin
{ string235, fn_listDir, 0x00 },
{ string236, fn_rm, 0x11 },
{ string237, fn_rmdir, 0x11 },
{ string238, fn_mkdir, 0x11 },
// Kaef end

//Megamemnon's uLisp Machine
{ string239, fn_clear_screen, 0x00},
{ string240, fn_screen_home, 0x00},
{ string241, fn_set_cursor_position, 0x22},
//End Megamemnon's uLisp Machine
...
//Megamemnon's uLisp Machine
#if defined serial1out
  if (c == '\n'){ 
    //character 0x0A is a control character for Parallel tv_text.spin
    Serial1.write('\r');
  }
  else{
    Serial1.write(c);
...
//Megamemnon's uLisp Machine
#if defined serial1out
      Serial1.write(8); Serial1.write(' '); Serial1.write(8);
#endif
//End Megamemnon's uLisp Machine
...
//Megamemnon's uLisp Machine
// gserial is heavily modified; compare uLisp's new gserial to version 4.0b
// to determine if this version of gserial can simply be reused without mods
int gserial () {
